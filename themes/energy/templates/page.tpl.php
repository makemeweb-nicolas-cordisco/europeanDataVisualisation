 ...
 *   logo, search box, ...
 *
 * - $page['featured']: Displayed below the header, take full width of
 *   screen -> main menu, global information, ...
 * - $page['tools']: Displayed on top right of content area,
 *   before the page title -> login/logout buttons, author information, ...
 *
 ...
 *   if not empty -> latest content, calendar, ...
 * - $page['content_top']: Displayed in middle column, right before
 *   the page title -> carousel, important news, ...
 * - $page['help']: Displayed between page title and content -> information
 *   about the page, contextual help, ...
 * - $page['content']: The main content of the current page.
 * - $page['content_right']: Large sidebar displayed on right of the content,
 *   if not empty -> 2 column layout
...
?>
  ...
  <div id="layout-body" class="container">
    ...
    <div class="row">
      ...
      <div id="sidebar-right" class="col-lg-<?php print ($cols['sidebar_right']['lg']); ?> col-md-<?php print ($cols['sidebar_right']['md']); ?> col-sm-<?php print ($cols['sidebar_right']['sm']); ?> col-xs-<?php print ($cols['sidebar_right']['xs']); ?> sidebar-right ">
